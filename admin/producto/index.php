<?php
	...
	foreach ($datos as $key => $value) {
		echo '<tr>';
			...
			echo '<td><a class="btn btn-success" href="../presentacion/index.php?id_producto='.$value['id_producto'].'" role="button"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span> Ver Presentaciones</a></td>';
